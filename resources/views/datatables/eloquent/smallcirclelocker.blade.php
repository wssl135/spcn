...
@section('tech')
<table id="techs-table" class="table table-condensed">
...
@section('js')
    $(function() {
        $('#techs-table').DataTable({
            processing: true,
            searching: true,
            serverSide: true,
            aLengthMenu: [[10,20,50,100,-1],[10,20,50,100,"All"]],
            ajax: '{{ url("eloquent/small-circle-locker-data") }}'
        });
        $('#product-table').DataTable({
            ...
            bLengthChange: true,
            aLengthMenu: [[10,20,50,100,-1],[10,20,50,100,"All"]],
            ajax: '{{ url("eloquent/small-circle-locker-product-data") }}'
        });
    });
@endsection
